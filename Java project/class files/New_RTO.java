...
public class New_RTO extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
    	if(ae.getSource()==b1){
    		...
    		String e = t6.getText();
    		String p = t7.getText();
    		RTOc r1 = new RTOc(n,g,a,s,c,e,p);
    		String qry = "insert into RTO values(null,'"+n+"','"+g+"','"+a+"','"+s+"','"+c+"','"+e+"','"+p+"')";
    		String qry1 = "insert into login1 values('"+c+"','"+e+"')";
    		try{
    			connection c1 = new connection();
    			c1.s.executeUpdate(qry);
    			c1.s.executeUpdate(qry1);
    			JOptionPane.showMessageDialog(null,"RTO ID Created");
