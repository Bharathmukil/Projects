...
public class JOlogin extends JFrame implements ActionListener{
    JLabel l1,l2;
    JTextField t1;
    JPasswordField t2;
    JButton b1,b2;
    ...
    public void actionPerformed(ActionEvent ae){
    	...
    	try
        {
            ...
            String q="select * from JOlogin where username='"+u+"' and password='"+v+"'";
            
            ResultSet rs=c1.s.executeQuery(q); 
            if(rs.next()){
                new JO().setVisible(true);
                setVisible(false);
            }else{
